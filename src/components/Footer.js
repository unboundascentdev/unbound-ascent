...
const socialLinks = [
  {
    label: "YouTube",
    href: "https://www.youtube.com/@CoachChrisBustos",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@coachchrisbustos",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/coachchrisbustos",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/christopher-bustos/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
